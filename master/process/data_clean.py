...
def clean_data(input_data):
    ...
    os.remove('./tmp.csv')
    meta_data = pd.read_csv('/home/ivan/Documents/hakathon peter/hackathon/vanya/process/meta_data_regions.csv')
    df = df.merge(meta_data,on='code')
    wind = rolling_window(df.iloc[:, 9:19])
    df = pd.concat([df,wind], axis=1)
    covi = pd.read_csv('/home/ivan/Documents/hakathon peter/hackathon/vanya/process/covid_Incident_Rate.csv')
    covi.columns = ['code', '1_covi','2_covi','3_covi','4_covi','5_covi','6_covi','7_covi','8_covi','9_covi','10_covi']
    covd = pd.read_csv('/home/ivan/Documents/hakathon peter/hackathon/vanya/process/covid_death.csv')
    covd.columns = ['code', '1_covd','2_covd','3_covd','4_covd','5_covd','6_covd','7_covd','8_covd','9_covd','10_covd']
    caseF = pd.read_csv('/home/ivan/Documents/hakathon peter/hackathon/vanya/process/ovid_Case_Fatality_Ratio.csv')
    caseF.columns = ['code', '1_caseF','2_caseF','3_caseF','4_caseF','5_caseF','6_caseF',
    '7_caseF','8_caseF','9_caseF','10_caseF']
    conf = pd.read_csv('/home/ivan/Documents/hakathon peter/hackathon/vanya/process/covid_confirmed.csv')
...
def format_output(data, path):
    with open('/home/ivan/Documents/hakathon peter/hackathon/vanya/process/dict.json') as f:
        d = json.load(f)
...
if __name__ == "__main__":
    clean_data('/home/ivan/Documents/hakathon peter/hackathon/vanya/process/test.csv')
